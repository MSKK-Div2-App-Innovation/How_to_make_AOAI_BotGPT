...
## Azure ポータルから Open AI リソースを作成する
...
## Azure OpenAI Studio へのモデルのデプロイ
...
しかしながら、このままでは、チャットボットを Web アプリケーションに組み込むことができません。

以降の演習では、Microsoft Bot Framework SDK を使用して、Azure OpenAI Studio で作成したチャットボットを Web アプリケーションに組み込むためのコードを作成します。
